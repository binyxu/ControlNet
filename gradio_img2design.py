...
model.load_state_dict(load_state_dict('/data/text2design/model_ckpts/controlnet_bsz_36_encode_with_vae/epoch=20-step=3999.ckpt', location='cuda'))
model = model.cuda()
...
def process(input_image, prompt, a_prompt, n_prompt, num_samples, image_resolution, ddim_steps, guess_mode, strength, scale, seed, eta):
    with torch.no_grad():
        ...
        control = (torch.from_numpy(img.copy()).float().cuda() / 127.5) - 1.0
